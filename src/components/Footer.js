...
const Footer = ({ version }) => <div className="flex justify-between items-center bg-white text-sm md:text-base
text-slate-600 p-1.5 border border-slate-300 sticky top-[100vh]">
  <span>
    <span className="hidden md:inline">Powered by Vercel, Railway and MongoDB Atlas. </span>
