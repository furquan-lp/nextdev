  ...
  <details className="font-aboutmono font-bold text-slate-600 md:text-2xl text-lg my-4 md:my-6 mx-1 md:mx-0">
    ...
    <div className="flex flex-col md:items-center">
      ...
      <div className="flex flex-col md:flex-row my-2 md:my-4">
        <a href="https://reactjs.org/" className="group flex flex-col border border-blue-react text-blue-react items-center m-1 md:mx-2 hover:bg-blue-react
          ...
          <span className="border-t border-blue-react group-hover:border-white mt-1 p-2 text-xl">ReactJS</span>
        </a>
        <a href="https://tailwindcss.com/" className="group flex flex-col border border-blue-tailwind text-blue-tailwind items-center m-1 md:mx-2 
          ...
          <span className="border-t border-blue-tailwind group-hover:border-white mt-1 p-2 text-xl">Tailwind</span>
        </a>
        <a href="https://www.material-tailwind.com/" className="group flex flex-col border border-blue-mui text-blue-mui items-center m-1 md:mx-2 hover:bg-blue-mui
          ...
          <span className="border-t border-blue-mui group-hover:border-white mt-1 p-2 text-xl">
